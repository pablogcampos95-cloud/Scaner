...
import MiniSpreadsheet from './MiniSpreadsheet.jsx';
...
export default function QuestionRenderer({ question, value, onChange }) {
  ...
  if (question.question_type === 'spreadsheet') return <MiniSpreadsheet question={question} value={value} onChange={onChange} />;
